    ...
    common_interrupt_handler:               ; the common parts of the generic interrupt handler
        ...
        ; push parameters for C function
        xor     eax, eax         ;Zero eax
        xor     ebx, ebx
        mov     ax, [esp + 32]  ;error code
        mov     bx, [esp + 34]  ;interrupt number
        push    ebx
        push    eax
        ...
        ; restore the stack pointer (The macro pushed two dwords)
        add     esp, 8
    ...
    ; Code generated by genInterruptHandlers.py
